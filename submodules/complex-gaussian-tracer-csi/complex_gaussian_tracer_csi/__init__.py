...
# Python bindings for complex-valued Gaussian tracer CUDA kernels (CSI variant)
...
class _TracerComplexGaussians(torch.autograd.Function):
    ...
    def forward(ctx,
        ...
        # Filter out Gaussians inside the receiver sphere (within scale_dis * radius)
        scale_dis = 1.5
    ...
    def backward(ctx, 
        ...
        # scatter gradients back to full tensor
